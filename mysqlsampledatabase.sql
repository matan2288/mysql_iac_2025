...
-- מחיקת products לפני productlines
DROP TABLE IF EXISTS productlines;
-- אחרונה כי אליה מפנים
/* Create the tables */
...
SELECT *
FROM productlines INTO OUTFILE '/Users/user/Desktop/Code/MySQL/IACRamatGanDBs' FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n';